...
import mission4.bowlingstate.domain.state.FirstBowl;
import mission4.bowlingstate.domain.state.Miss;
import mission4.bowlingstate.domain.state.Ready;
import mission4.bowlingstate.domain.state.Spare;
import mission4.bowlingstate.domain.state.State;
import mission4.bowlingstate.domain.state.Strike;
